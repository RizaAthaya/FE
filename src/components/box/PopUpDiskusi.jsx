...
//components
import PopUpDiskusiBerhasil from "./PopUpDiskusiBerhasil";
...
const PopUpDiskusi = (props) => {
  ...
  return (
    <div className="popup-diskusi">
      <div className={`diskusi-${berhasil}`}>
      ...
      <div className="form-diskusi">
        ...
        <div className="paket-form">
          ...
          <h3 className="penjelasan-formDiskusi">
            Uraikan pertanyaan kamu lebih panjang dan jelas pada bagian ini.
          </h3>
        </div>
        <div className="paket-form">
          ...
          <h3 className="penjelasan-formDiskusi">
            Tuliskan beberapa kata kunci pertanyaan kamu di sini dengan tanda
            koma sebagai pemisah
          </h3>
        </div>
        <button className="btn-buatDiskusi" onClick={onClick}>
          Buat Diskusi
        </button>
      </div>
    </div>
